...
site:
  ...
  name:
    ...
    class: text
    # 具体内容 例如：solitude st-logo / 王卓Sco / https://p.sondy.top/logo.png
    # Specific content, for example: solitude st-logo / 王卓Sco / https://p.sondy.top/logo.png
    custom: Solitude
  # 网页icon
  # Web icon
  siteIcon: https://7.isyangs.cn/1/65eb200ee4dea-1.png
  # 页脚的Logo、加载动画默认的logo
  # Logo in the footer, default logo for loading animation
  icon: https://7.isyangs.cn/1/65eb200ee4dea-1.png
...
post:
  ...
  award:
    ...
    # 微信收款码
    # WeChat payment code
    wechat: https://7.isyangs.cn/1/65eb45f428df9-1.png
    # 支付宝收款码
    # Alipay payment code
    alipay: https://7.isyangs.cn/1/65eb45fcd2198-1.png
    # 打赏统计页面链接
